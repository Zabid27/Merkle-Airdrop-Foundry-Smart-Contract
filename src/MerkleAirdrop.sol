...
contract MerkleAirdrop is EIP712 {
    ...
    // Allow someone inthe list to claim token
    ...
    // merkle proofs
    // Allow someone to claim ERC-20 token
    ...
    function claim(
        ...
        // Before we sent out the token , we first want them to emit the event
        emit Claimed(account, amount);
        // Incase the receiver account's can't receive an ERC20 Token, then we need to use SafeTransfer from openzeppelin
